#!/usr/bin/env python3
"""Reports the JRC blog publish result back to the repo via the GitHub Contents API."""
import os
import json
import base64
...
RESULT_FILE = "jrc_publish_result.json"
...
put_payload = {"message": "chore: jrc blog publish result", "content": content_b64}
if sha:
    put_payload["sha"] = sha
