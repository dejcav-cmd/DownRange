...
for d in real:
    ...
    if w < 150 or h < 110: bad.append((d, f'{w}x{h} too small'))
    elif w * h < 30000: bad.append((d, f'{w}x{h} too few pixels'))
    elif w / h > 10: bad.append((d, f'{w}x{h} strip/banner'))
    elif h / w > 3.5: bad.append((d, f'{w}x{h} extreme portrait'))
