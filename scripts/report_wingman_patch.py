#!/usr/bin/env python3
"""Reports the wingman patch result back to the repo via the GitHub Contents API."""
import os
import json
import base64
...
RESULT_FILE = "wingman_patch_result.json"
...
put_payload = {"message": "chore: wingman patch result", "content": content_b64}
if sha:
    put_payload["sha"] = sha
