...
export default function NotFound() {
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '24px', padding: '40px' }}>
      ...
      <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
        ...
        <Link href="/" style={{ background: 'transparent', color: '#9CA3AF', border: '1px solid var(--border)', padding: '10px 24px', fontFamily: "'IBM Plex Mono',monospace", fontSize: '13px', textDecoration: 'none' }}>
          HOME
        </Link>
      </div>
    </div>
