  ...
  return (
    <>
      ...
      <div style={{background:'linear-gradient(180deg,#09090B 0%,#0d1117 100%)',borderBottom:'1px solid var(--border)',padding:'48px 0 32px',position:'relative',overflow:'hidden'}}>
        <div style={{position:'absolute',inset:0,backgroundImage:'url(/img/photos/news.jpg',backgroundPosition:'right center',backgroundSize:'600px',backgroundRepeat:'no-repeat',opacity:.04}} />
