...
const HUNTING_GUIDES = [
  { slug:'whitetail-hunting-guide',     title:'Whitetail Deer Hunting: The Complete System', subtitle:'Scouting, stand placement, scent control, shot placement. Every variable that closes the gap between hunter and deer.', category:'Hunting', readTime:'18 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', featured:true, date:'Sep 2026' },
  { slug:'elk-hunting-guide',           title:'Elk Hunting: Public Land Strategy',           subtitle:'DIY elk without an outfitter. Unit selection, OTC tags, calling during the rut, physical preparation, and meat care.', category:'Hunting', readTime:'22 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', featured:true, date:'Aug 2026' },
  { slug:'turkey-hunting-basics',       title:'Turkey Hunting from Scratch',                 subtitle:'Pre-season scouting, decoy setups, call selection, and the timing edge that fills your tag every spring.', category:'Hunting', readTime:'14 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', featured:true, date:'Mar 2026' },
  { slug:'cartridge-selection-guide',   title:'Choosing the Right Hunting Cartridge',       subtitle:'From .243 Win for deer to .300 Win Mag for elk — match the cartridge to the animal, the range, and your recoil tolerance.', category:'Ammunition', readTime:'16 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', date:'Jul 2026' },
  { slug:'field-dressing-deer',         title:'Field Dressing Your Deer: Step-by-Step',     subtitle:'From shot to cooler in under an hour. Proper technique prevents contamination and preserves meat quality.', category:'Skills', readTime:'10 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', date:'Oct 2026' },
  { slug:'hunting-rifle-selection',     title:'Best Hunting Rifles for Every Budget',        subtitle:'From the $549 Savage 110 to the $1,999 Tikka T3x — the right bolt gun for your game and your budget.', category:'Gear', readTime:'13 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', date:'Aug 2026' },
]

const PRECISION_GUIDES = [
  { slug:'prs-beginners-guide',          title:'PRS Practical Rifle: Getting Started',          subtitle:'Your first PRS match — gear requirements, positional shooting, reading wind, and the mental game.', category:'Precision', readTime:'17 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', featured:true, date:'Jun 2026' },
  { slug:'long-range-ballistics',        title:'Long Range Ballistics Without the Guesswork',   subtitle:'BC, velocity, drop, and wind drift explained. How to build a DOPE card and trust your data at 800 yards.', category:'Precision', readTime:'20 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', featured:true, date:'May 2026' },
  { slug:'6-5-creedmoor-deep-dive',      title:'6.5 Creedmoor: Why It Won',                    subtitle:'The ballistics case for 6.5 CM. BC comparison to .308, recoil numbers, factory ammo performance, and when to choose something else.', category:'Ammunition', readTime:'12 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', date:'Apr 2026' },
  { slug:'rifle-scope-guide',            title:'Scope Selection: MRAD vs MOA, Magnification',   subtitle:'First vs second focal plane, turret quality, glass clarity at price tiers, and the scopes worth your money.', category:'Gear', readTime:'15 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', date:'Mar 2026' },
]

const TRAINING_GUIDES = [
  { slug:'30-day-dry-fire-plan',         title:'30-Day Dry Fire Plan: Zero Ammo Required',     subtitle:'A progressive dry fire curriculum that builds trigger control, sight picture, and presentation in one month flat.', category:'Training', readTime:'11 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', featured:true, date:'Jun 2026' },
  { slug:'first-shooting-lesson',        title:'Teaching Someone to Shoot for the First Time',  subtitle:'Safety briefing, grip, stance, trigger press, and the mental approach that turns a nervous first-timer into a confident shooter.', category:'Training', readTime:'9 min',  img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', featured:true, date:'May 2026' },
  { slug:'one-handed-shooting',          title:'One-Handed Shooting Technique',                 subtitle:'Strong hand and support hand shooting. Why you train it, how to build accuracy, and the drills that transfer to real-world retention.', category:'Training', readTime:'8 min',  img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', date:'Jul 2026' },
  { slug:'home-defense-drill-plan',      title:'Home Defense: Training for the Real Scenario',  subtitle:'Low light, hallway geometry, door stacking, family communication protocols, and the drills that actually matter at 3 AM.', category:'Training', readTime:'13 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg', date:'Aug 2026' },
]

const PREPAREDNESS_GUIDES = [
  { slug:'home-defense-setup',           title:'Home Defense Setup: Every Room, Every Scenario', subtitle:'Room-by-room planning, safe storage accessible under pressure, communication with family, and the equipment list that actually matters.', category:'Home Defense', readTime:'16 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg', featured:true, date:'May 2026' },
  { slug:'go-bag-essentials',            title:'The Real Go-Bag: What Actually Matters',          subtitle:'72-hour kit built around actual threats: power outage, evacuation, and shelter-in-place. No fantasy prepper nonsense.', category:'Preparedness', readTime:'14 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg', date:'Jun 2026' },
  { slug:'firearm-safe-storage-guide',   title:'Gun Safe Selection: What Protects Your Guns',   subtitle:'Fire rating realities, pry resistance, biometric reliability, and the safes that actually pass the test when seconds count.', category:'Storage', readTime:'11 min', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg', date:'Jul 2026' },
]
