...
const SAFES = [
  { name:'Fort Knox PB1 Handgun Safe', category:'Quick-Access', price:200, rating:9.2, image:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg', pros:['Simplex mechanical lock — no batteries','Heavy 10-gauge steel','No electronics to fail','Lifetime warranty'], cons:['Combination only','Holds 1–2 handguns'], verdict:'Best for reliability purists. Mechanical lock means it works every time, no dead batteries.' },
  { name:'Hornady RAPiD Safe', category:'Biometric', price:170, rating:8.8, image:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg', pros:['RFID tag + fingerprint + keypad','Multiple access methods','Spring-assisted lid','AC + battery backup'], cons:['Fingerprint reader can be slow when wet','Small interior'], verdict:'Best multi-access quick safe. RFID means you just tap a bracelet or card — fastest entry.' },
  { name:'Vaultek VT20i', category:'Biometric', price:229, rating:9.0, image:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg', pros:['Bluetooth app monitoring','Anti-pry bars','Rechargeable battery','Impact detection alert'], cons:['Bluetooth adds complexity','Higher price'], verdict:'Best tech-forward safe. App alerts you if someone tampers with it. Good for bedside.' },
  { name:'Liberty Safe Fat Boy Jr', category:'Full Vault', price:1399, rating:9.4, image:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg', pros:['1200°F fire rating (75 min)','30 long gun capacity','Relocker system','12-gauge steel body'], cons:['700+ lbs — need help installing','Price'], verdict:'Best long gun vault. If you have a collection, this is the answer. Fire-rated and burglary-rated.' },
  { name:'GunVault MiniVault Deluxe', category:'Quick-Access', price:99, rating:8.3, image:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg', pros:['Budget-friendly','No-look keypad','Compact and mountable','Cable included'], cons:['16-gauge steel (thinner)','Keypad-only'], verdict:'Best budget option. Gets the job done at minimum cost. Perfect for first handgun safe.' },
]
