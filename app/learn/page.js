...
const ARTICLES = [
  { slug:'buying-your-first-gun',       title:"Buying Your First Gun: The Complete Beginner's Guide",     subtitle:'Everything you need to know before walking into a gun store.',                       category:'Getting Started', readTime:'12 min', date:'May 15', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Walther_P99Q.jpg/1920px-Walther_P99Q.jpg', featured:true },
  { slug:'how-to-get-ccw-license',      title:'How to Get Your CCW License (State-by-State Guide)',        subtitle:'Concealed carry permits explained: requirements, costs, and training.',              category:'CCW & Carry',     readTime:'15 min', date:'May 18', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Concealed_Carry_Holster_Handgun.jpg/1280px-Concealed_Carry_Holster_Handgun.jpg', featured:true },
  { slug:'firearms-safety-four-rules',  title:'The Four Rules of Firearms Safety (And Why They Save Lives)', subtitle:'These rules are not suggestions. Every accident violates at least one.',           category:'Safety',          readTime:'8 min',  date:'May 20', img:'https://upload.wikimedia.org/wikipedia/commons/e/ed/Control_station_for_an_indoor_firing_range.jpg', featured:true },
  { slug:'home-defense-basics',         title:'Home Defense Basics: What You Actually Need',               subtitle:'The right firearm, a workable plan, the right storage.',                          category:'Home Defense',    readTime:'11 min', date:'Jun 2',  img:'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Mossberg_590A1.jpg/1280px-Mossberg_590A1.jpg' },
  { slug:'safe-storage-guide-beginners',title:'Safe Storage 101: Keeping Your Guns Secure and Accessible', subtitle:'Prevent theft and accidents without sacrificing defensive access.',                 category:'Safe Storage',    readTime:'9 min',  date:'Jun 5',  img:'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Cannon_Safe.jpg/1280px-Cannon_Safe.jpg' },
  { slug:'ammo-guide-beginners',        title:'Ammunition Explained: What to Buy and Why',                 subtitle:'Calibers, grain weights, hollow points vs FMJ — simplified.',                     category:'Ammunition',      readTime:'10 min', date:'Jun 9',  img:'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/9_mm_Parabellum.jpg/1280px-9_mm_Parabellum.jpg' },
  { slug:'shooting-range-first-visit',  title:'Your First Time at a Shooting Range: What to Expect',       subtitle:'Rules, etiquette, and how to make the most of your first session.',                category:'Getting Started',  readTime:'7 min',  date:'Jun 12', img:'https://upload.wikimedia.org/wikipedia/commons/8/8f/Composite_Indoor_Shooting_Range.jpg' },
  { slug:'cleaning-maintaining-your-gun',title:'How to Clean and Maintain Your Firearm',                   subtitle:'Field strip, clean, and lubricate your pistol in 20 minutes.',                   category:'Maintenance',     readTime:'10 min', date:'Jun 16', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Glock_17_fieldstripped.jpg/1280px-Glock_17_fieldstripped.jpg' },
  { slug:'understanding-gun-laws',      title:'Understanding Gun Laws: A Beginner\'s Legal Overview',       subtitle:'Federal law, state law, and how they interact — what you need to know.',          category:'Legal',           readTime:'13 min', date:'Jun 19', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/United_States_Supreme_Court_Building.jpg/1280px-United_States_Supreme_Court_Building.jpg' },
  { slug:'choosing-holster-beginners',  title:'How to Choose a Holster for Concealed Carry',               subtitle:'IWB, OWB, appendix — how to choose the right carry method.',                     category:'CCW & Carry',     readTime:'11 min', date:'Jun 23', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Safariland_Level_III_Holster.jpg/1280px-Safariland_Level_III_Holster.jpg' },
  { slug:'dry-fire-training-beginners', title:'Dry Fire Training: Get Better Without Spending on Ammo',    subtitle:'Professional shooters spend more time dry firing than live firing.',               category:'Training',        readTime:'9 min',  date:'Jun 27', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/USMC_pistol_training.jpg/1280px-USMC_pistol_training.jpg' },
  { slug:'what-is-nfa',                 title:'What Is the NFA? Suppressors, SBRs, and More Explained',    subtitle:'After the 2026 tax stamp elimination, NFA item interest exploded. Here\'s the guide.', category:'Legal',       readTime:'12 min', date:'Jul 1',  img:'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Silencer-Group.jpg/1280px-Silencer-Group.jpg' },
]
