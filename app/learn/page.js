...
const ARTICLES = [
  ...
  { slug:'how-to-get-ccw-license',      title:'How to Get Your CCW License (State-by-State Guide)',        subtitle:'Concealed carry permits explained: requirements, costs, and training.',              category:'CCW & Carry',     readTime:'15 min', date:'May 18', img:'/img/learn/how-to-get-ccw-license.jpg', featured:true },
  { slug:'firearms-safety-four-rules',  title:'The Four Rules of Firearms Safety (And Why They Save Lives)', subtitle:'These rules are not suggestions. Every accident violates at least one.',           category:'Safety',          readTime:'8 min',  date:'May 20', img:'/img/learn/firearms-safety-four-rules.jpg', featured:true },
  { slug:'home-defense-basics',         title:'Home Defense Basics: What You Actually Need',               subtitle:'The right firearm, a workable plan, the right storage.',                          category:'Home Defense',    readTime:'11 min', date:'Jun 2',  img:'/img/learn/home-defense-basics.jpg' },
  { slug:'safe-storage-guide-beginners',title:'Safe Storage 101: Keeping Your Guns Secure and Accessible', subtitle:'Prevent theft and accidents without sacrificing defensive access.',                 category:'Safe Storage',    readTime:'9 min',  date:'Jun 5',  img:'/img/photos/homedefense.jpg' },
  { slug:'ammo-guide-beginners',        title:'Ammunition Explained: What to Buy and Why',                 subtitle:'Calibers, grain weights, hollow points vs FMJ — simplified.',                     category:'Ammunition',      readTime:'10 min', date:'Jun 9',  img:'/img/learn/ammo-guide-beginners.jpg' },
  { slug:'shooting-range-first-visit',  title:'Your First Time at a Shooting Range: What to Expect',       subtitle:'Rules, etiquette, and how to make the most of your first session.',                category:'Getting Started',  readTime:'7 min',  date:'Jun 12', img:'/img/learn/shooting-range-first-visit.jpg' },
  ...
  { slug:'understanding-gun-laws',      title:'Understanding Gun Laws: A Beginner\'s Legal Overview',       subtitle:'Federal law, state law, and how they interact — what you need to know.',          category:'Legal',           readTime:'13 min', date:'Jun 19', img:'/img/learn/understanding-gun-laws.jpg' },
  { slug:'choosing-holster-beginners',  title:'How to Choose a Holster for Concealed Carry',               subtitle:'IWB, OWB, appendix — how to choose the right carry method.',                     category:'CCW & Carry',     readTime:'11 min', date:'Jun 23', img:'/img/learn/choosing-holster-beginners.jpg' },
  { slug:'dry-fire-training-beginners', title:'Dry Fire Training: Get Better Without Spending on Ammo',    subtitle:'Professional shooters spend more time dry firing than live firing.',               category:'Training',        readTime:'9 min',  date:'Jun 27', img:'/img/learn/dry-fire-training-beginners.jpg' },
  { slug:'what-is-nfa',                 title:'What Is the NFA? Suppressors, SBRs, and More Explained',    subtitle:'After the 2026 tax stamp elimination, NFA item interest exploded. Here\'s the guide.', category:'Legal',       readTime:'12 min', date:'Jul 1',  img:'/img/photos/suppressor.jpg' },
]
