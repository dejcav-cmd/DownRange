...
const ARTICLES = {
  ...
  'home-defense-basics': {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg',
  ...
  'shooting-range-first-visit': {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg',
  ...
  'understanding-gun-laws': {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/US_Supreme_Court_Building.jpg/1280px-US_Supreme_Court_Building.jpg',
...
const HERO_IMAGES = {
  'buying-your-first-gun':        'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg',
  'how-to-get-ccw-license':       'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg',
  'firearms-safety-four-rules':   'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg',
  'home-defense-basics':          'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg',
  'safe-storage-guide-beginners': 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg',
  'ammo-guide-beginners':         'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg',
  'shooting-range-first-visit':   'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg',
  ...
  'dry-fire-training-beginners':  'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg',
  'what-is-nfa':                  'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/M4A1_SOPMOD_Block_II.jpg/1280px-M4A1_SOPMOD_Block_II.jpg',
}
                ...
                <Link key={slug} href={`/learn/${slug}`} style={{ textDecoration:'none', display:'block' }}>
                  <div style={{ background:'var(--bg2)', border:'1px solid var(--border)', overflow:'hidden', transition:'border-color 0.15s' }}>
                    <div style={{ height:'80px', overflow:'hidden' }}>
                      <img src={HERO_IMAGES[slug] || a.heroImage || 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Glock17.jpg/1280px-Glock17.jpg'} alt={a.title}
