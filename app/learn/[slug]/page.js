...
const HERO_IMAGES = {
  'buying-your-first-gun':        '/img/pistol.svg',
  'how-to-get-ccw-license':       '/img/pistol.svg',
  'firearms-safety-four-rules':   '/img/rifle.svg',
  'home-defense-basics':          '/img/pistol.svg',
  'safe-storage-guide-beginners': '/img/pistol.svg',
  'ammo-guide-beginners':         '/img/pistol.svg',
  'shooting-range-first-visit':   '/img/rifle.svg',
  'cleaning-maintaining-your-gun':'/img/pistol.svg',
  'understanding-gun-laws':       '/img/law.svg',
  'choosing-holster-beginners':   '/img/pistol.svg',
  'dry-fire-training-beginners':  '/img/rifle.svg',
  'what-is-nfa':                  '/img/rifle.svg',
}
                ...
                <Link key={slug} href={`/learn/${slug}`} style={{ textDecoration:'none', display:'block' }}>
                  <div style={{ background:'var(--bg2)', border:'1px solid var(--border)', overflow:'hidden', transition:'border-color 0.15s' }}>
                    <div style={{ height:'80px', overflow:'hidden' }}>
                      <img src={HERO_IMAGES[slug] || a.heroImage || '/img/pistol.svg'} alt={a.title}
