...
const ARTICLES = {
  ...
  'safe-storage-guide-beginners': {
    ...
    heroImage: '/img/photos/homedefense.jpg',
  ...
  'what-is-nfa': {
    ...
    heroImage: '/img/photos/suppressor.jpg',
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: { canonical: `https://downrangeco.com/learn/${params.slug}` },
    openGraph: {
      title: a.title,
      description: a.subtitle,
