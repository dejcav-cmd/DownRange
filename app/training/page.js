...
export const metadata = { title: 'Firearms Training & Drills — DownRange', description: 'Dry fire plans, live fire drills, and training resources. No theory — just the drills that build real skill.', alternates: { canonical: 'https://www.downrangeco.com/training' } }
