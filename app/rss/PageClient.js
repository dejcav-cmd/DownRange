...
const FEEDS = [
  {
    ...
    url:    '/feed.xml',
    color:  '#C8922A',
    desc:   'Everything in one feed — news, blog, releases, legislation, and more. The full DownRange master feed.',
    badge:  'MASTER',
    count:  '60 items',
    update: 'Every 15 min',
  ...
  },
  {
    ...
    url:    '/feeds/news',
    color:  '#3b82f6',
    desc:   'Live 2A and firearms news pulled from 13+ verified sources. ATF actions, legislation, industry, breaking stories.',
    badge:  'MOST POPULAR',
    count:  '50 items',
    update: 'Every 15 min',
  ...
  },
  {
    ...
    url:    '/feeds/laws',
    color:  '#ef4444',
    desc:   'Second Amendment legislation, court cases, ATF rules, Bruen decisions, and rights advocacy updates.',
    badge:  null,
    count:  '50 items',
    update: 'Every 2 hrs',
  ...
  },
  {
    ...
    url:    '/feeds/releases',
    color:  '#C8922A',
    desc:   'New firearm releases and product announcements from 16+ manufacturers — Glock, SIG, S&W, Ruger, Daniel Defense, and more.',
    badge:  null,
    count:  '30 items',
    update: 'Hourly',
    tags:   ['pistol','rifle','new','manufacturer'],
  },
  {
    id:     'blog',
    title:  'Blog & Analysis',
    ...
    url:    '/feeds/blog',
    color:  '#22c55e',
    desc:   'In-depth articles, gear guides, and firearms analysis written by DJ Cavalcanti and the DownRange team.',
    badge:  null,
    count:  '30 items',
    update: 'Weekly',
  ...
  },
  {
    ...
    url:    '/feeds/reviews',
    color:  '#a855f7',
    desc:   'Firearm and gear reviews — hands-on testing and honest assessments.',
    badge:  null,
    count:  '30 items',
    update: 'On publish',
  ...
  },
  {
    ...
    url:    '/feeds/giveaways',
    color:  '#f43f5e',
    desc:   'Active firearm, ammo, and gear giveaways from top manufacturers, retailers, and 2A organizations. Verified — no spam.',
    badge:  'NEW',
    count:  '50 items',
    update: 'Daily',
    tags:   ['giveaway','free','2A'],
  },
  {
    id:     'hunting',
    ...
    url:    '/feeds/hunting',
    color:  '#65a30d',
    desc:   'Hunting news, gear reviews, season updates, and outdoors content for the tactical hunter.',
    badge:  'NEW',
    count:  '40 items',
    update: 'Daily',
    tags:   ['hunting','outdoor','gear'],
  },
  {
    id:     'deals',
    title:  'Gun Deals',
    ...
    url:    '/feeds/deals',
    color:  '#06b6d4',
    desc:   'Verified firearms, ammo, and gear deals from trusted retailers. Price drops, sales, and clearances.',
    badge:  'NEW',
    count:  '50 items',
    update: 'Every 4 hrs',
    tags:   ['deals','ammo','gear','price'],
  },
  {
    id:     'video',
    title:  'Firearms Videos',
    emoji:  '▶',
    url:    '/feeds/video',
    color:  '#f97316',
    desc:   'Curated firearms video content — reviews, training, news, and tactical content from verified channels.',
    badge:  'NEW',
    count:  '40 items',
    update: 'Every 4 hrs',
    tags:   ['video','review','training'],
  },
  {
    id:     'competitions',
    title:  'Competitions',
    ...
    color:  '#f59e0b',
    desc:   'NRA, USPSA, IDPA, PRS, NRL22, Steel Challenge — upcoming matches and shooting competitions with registration links.',
    badge:  null,
    count:  '50 items',
    update: 'Daily',
  ...
  },
  {
    ...
    url:    '/feeds/canada',
    color:  '#dc2626',
    desc:   'Canadian firearms news — Bill C-21, OIC ban, PAL updates, CCFR legal challenges, and policy coverage.',
    badge:  null,
    count:  '30 items',
    update: 'Twice daily',
    ...
    <>
      ...
      <div style={{
        ...
        <div className="container" style={{ position: 'relative' }}>
          ...
          <p style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: 12, color: '#6b7280', maxWidth: 580, lineHeight: 1.9, margin: '0 0 32px' }}>
            Every section has its own dedicated feed. Pull firearms news, legislation, new releases, giveaways, deals, videos, hunting content, competitions, or Canadian law directly into your RSS reader. Updated continuously — no paywalls, no tracking.
          </p>
        ...
        <div className="container">
          ...
          <div style={{ marginTop: 60, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 }}>
            <div>
              ...
              <p style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: 11, color: '#6b7280', lineHeight: 1.9, marginBottom: 12 }}>
                RSS (Really Simple Syndication) is an open format that lets you follow websites without visiting them. Your reader checks feeds automatically and shows new content in one place — no algorithm, no ads, no engagement bait.
              </p>
              <p style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: 11, color: '#6b7280', lineHeight: 1.9 }}>
                It's the fastest way to stay current on 2A news, new releases, and legislation without doomscrolling social media. Set it and forget it.
              </p>
            </div>
            <div>
              <div style={{ fontFamily: "'Bebas Neue',cursive", fontSize: '1.6rem', color: '#F0EDE6', letterSpacing: '.04em', marginBottom: 16 }}>
          ...
          <div style={{ marginTop: 40, padding: '24px 28px', background: 'rgba(200,146,42,.05)', border: '1px solid rgba(200,146,42,.25)', display: 'flex', gap: 20, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontFamily: "'Bebas Neue',cursive", fontSize: '1.3rem', color: '#F0EDE6', letterSpacing: '.04em', marginBottom: 4 }}>
                Import All 12 Feeds at Once — OPML Bundle
              </div>
          ...
          <div style={{ marginTop: 24, padding: '16px 20px', border: '1px solid var(--border)', background: 'var(--bg2)' }}>
            ...
            <div style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: 10, color: '#4b5563', lineHeight: 1.9 }}>
              ...
              Feeds update on their respective schedules and are cached for performance.
            </div>
          </div>
