    ...
    <>
      ...
      <div style={{ padding: '40px 0' }}>
        <div className="container" style={{ maxWidth: 760 }}>
          <div style={{ background: '#111318', border: '1px solid #1F2428', padding: '32px', marginBottom: '32px' }}>
            ...
            <p style={{ fontFamily: 'monospace', fontSize: '13px', color: '#6B7280', marginBottom: '20px', lineHeight: 1.7 }}>
              Add two lines to any page on your website. Replace TX with your state abbreviation.
            </p>
            <div style={{ background: '#0D1117', border: '1px solid #1F2428', padding: '20px', fontFamily: 'monospace', fontSize: '13px', color: '#34D399', lineHeight: 2 }}>
              {'<div id="downrange-widget"></div>'}<br/>
              {'<script src="https://downrangeco.com/api/widget?state=TX&format=js"></script>'}
            </div>
          </div>
          <div style={{ background: '#111318', border: '1px solid #1F2428', padding: '32px' }}>
