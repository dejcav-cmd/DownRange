...
const PISTOLS = [
  { slug:'glock-19',          name:'Glock 19',         caliber:'9mm Luger',      action:'Striker-fired',   capacity:'15+1',   msrp:'$499–$599',   rating:'9.6', img:'/img/pistol.svg', tagline:'The universal carry standard. Compact frame, full-size performance. Over 70 million sold globally.', role:'Duty / EDC / Home Defense' },
  { slug:'sig-p320',          name:'SIG P320',          caliber:'9mm / .357 SIG / .40 S&W', action:'Striker-fired modular', capacity:'17+1', msrp:'$499–$699', rating:'9.4', img:'/img/pistol.svg', tagline:'US Army M17/M18. Modular serialized FCU swaps frames and calibers. No external safety needed.', role:'Military / Duty / Modular' },
  { slug:'glock-43x',         name:'Glock 43X MOS',     caliber:'9mm Luger',      action:'Striker-fired',   capacity:'10+1',   msrp:'$549–$599',   rating:'9.2', img:'/img/pistol.svg', tagline:'Slim-line EDC with MOS optic cut standard. 1.1" wide. Zero malfunctions in 2,000+ round testing.', role:'Concealed Carry' },
  { slug:'cz-p10c',           name:'CZ P-10 C',          caliber:'9mm Luger',      action:'Striker-fired',   capacity:'15+1',   msrp:'$449–$549',   rating:'9.1', img:'/img/pistol.svg', tagline:'Best trigger in the striker-fired class at the price. Czech military-spec. Glock 19 competitor that wins on feel.', role:'Duty / Competition / EDC' },
  { slug:'walther-pdp',       name:'Walther PDP',        caliber:'9mm Luger',      action:'Striker-fired',   capacity:'18+1',   msrp:'$699–$749',   rating:'9.3', img:'/img/pistol.svg', tagline:'Performance Duty Pistol. Factory trigger rivals aftermarket units. Used by German SEK tactical units.', role:'Duty / Competition' },
  { slug:'springfield-hellcat', name:'Springfield Hellcat Pro', caliber:'9mm Luger', action:'Striker-fired', capacity:'15+1',  msrp:'$499–$549',   rating:'9.0', img:'/img/pistol.svg', tagline:'Highest capacity micro-compact on the market. Optics ready. Flat-faced trigger. Sub-inch width.', role:'Micro-Compact EDC' },
]

const RIFLES = [
  { slug:'ar-15',             name:'AR-15 Platform',    caliber:'5.56 NATO / .223 Rem', action:'Semi-auto gas-operated', capacity:'30+1', msrp:'$700–$2,500+', rating:'9.8', img:'/img/rifle.svg', tagline:'America\'s rifle. 15+ million owned. Modular, accurate, reliable. The most customizable platform in firearms history.', role:'Home Defense / Sport / Hunting' },
  { slug:'ak-47',             name:'AK Platform',       caliber:'7.62×39mm',      action:'Semi-auto gas-operated', capacity:'30+1', msrp:'$800–$1,800', rating:'9.5', img:'/img/rifle.svg', tagline:'100+ million produced. Loose tolerances mean legendary reliability in adverse conditions. The global standard.', role:'Home Defense / Collection' },
  { slug:'ruger-10-22',       name:'Ruger 10/22',       caliber:'.22 LR',         action:'Semi-auto blowback',     capacity:'10+1', msrp:'$279–$399',   rating:'9.4', img:'/img/rifle.svg', tagline:'The best-selling rimfire in history. 5+ million made. Enormous aftermarket. Perfect trainer and small game rifle.', role:'Training / Small Game / Plinking' },
  { slug:'daniel-defense-ddm4', name:'Daniel Defense DDM4 V7', caliber:'5.56 NATO', action:'Semi-auto DI', capacity:'30+1', msrp:'$1,999', rating:'9.4', img:'/img/rifle.svg', tagline:'Cold hammer-forged barrel. HPT/MPI-tested BCG. Sub-MOA guarantee. Used by SEAL Team Six.', role:'Duty / Home Defense' },
  { slug:'tikka-t3x',         name:'Tikka T3x Lite',    caliber:'6.5 CM / .308 / .300 WM', action:'Bolt-action', capacity:'3+1', msrp:'$699–$849', rating:'9.4', img:'/img/rifle.svg', tagline:'Sub-MOA factory guarantee. Lightest bolt-action in class. Used by professional guides on 5 continents.', role:'Hunting / Precision' },
  { slug:'remington-700',     name:'Remington 700',     caliber:'All major hunting calibers', action:'Bolt-action', capacity:'4+1', msrp:'$699–$899', rating:'9.2', img:'/img/rifle.svg', tagline:'60-year benchmark. US Marine Corps M40 sniper platform. Enormous aftermarket. The bolt-gun that all others copy.', role:'Hunting / Precision / Sniper' },
]

const SHOTGUNS = [
  { slug:'mossberg-590a1',    name:'Mossberg 590A1',    caliber:'12 Gauge',       action:'Pump-action',     capacity:'9+1',    msrp:'$649–$799',   rating:'9.1', img:'/img/shotgun.svg', tagline:'Only pump shotgun to pass US military MIL-SPEC testing. Tang safety, dual extractors, heavy-wall barrel.', role:'Military / Home Defense' },
  { slug:'benelli-m2',        name:'Benelli M2 Field',  caliber:'12 Gauge',       action:'Inertia semi-auto', capacity:'3+1',  msrp:'$1,449–$1,749', rating:'9.3', img:'/img/shotgun.svg', tagline:'Inertia-driven. No gas system to clean. Runs any load from field to 3.5" magnums. The guide gun standard.', role:'Hunting / Competition' },
  { slug:'remington-870',     name:'Remington 870',     caliber:'12 Gauge',       action:'Pump-action',     capacity:'4+1',    msrp:'$399–$549',   rating:'8.8', img:'/img/shotgun.svg', tagline:'11+ million sold since 1951. Most popular shotgun in history. Law enforcement and home defense standard.', role:'Home Defense / Hunting' },
  { slug:'benelli-supernova', name:'Benelli SuperNova', caliber:'12 Gauge',       action:'Pump-action',     capacity:'4+1',    msrp:'$549–$699',   rating:'9.0', img:'/img/shotgun.svg', tagline:'SteadyGrip stock option. Comforttech recoil reduction. Runs 3.5" magnums all day. Waterfowl specialist.', role:'Waterfowl / 3-Gun' },
]

const SUPPRESSORS = [
  { slug:'silencerco-omega-36m', name:'SilencerCo Omega 36M', caliber:'Multi-Caliber to .300 Win', action:'N/A', capacity:'N/A', msrp:'$999', rating:'9.4', img:'/img/rifle.svg', tagline:'Most versatile suppressor made. Configures short or standard. Titanium/Inconel. No $200 tax stamp since Jan 2026.', role:'Rifle / Pistol Multi-Cal' },
  { slug:'silencerco-omega-9k', name:'SilencerCo Omega 9K', caliber:'9mm / .300 BLK', action:'N/A', capacity:'N/A', msrp:'$799', rating:'9.3', img:'/img/rifle.svg', tagline:'Most compact pistol suppressor without sacrifice. 5.08" barely affects holster. Runs dirty 9mm and subsonic .300 BLK.', role:'Pistol / SBR' },
  { slug:'dead-air-sandman-s', name:'Dead Air Sandman-S', caliber:'.308 Win / 7.62mm', action:'N/A', capacity:'N/A', msrp:'$899', rating:'9.2', img:'/img/rifle.svg', tagline:'Direct-thread and QD. Full-auto rated. Handles .308 suppression at the sub-$1K price point better than anyone.', role:'Precision Rifle / Hunting' },
]
