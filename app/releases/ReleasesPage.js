...
const SEED_RELEASES = [
  { _id:'s1',  brand:'Glock',              model:'G47 MOS',            category:'Pistol',  caliber:'9mm',       action:'Safe Action',   msrp:599,  isJustDropped:true,  imageUrl:'/img/pistol.svg',           summary:"Full-size duty pistol with optics-ready slide, 17+1 capacity. Latest Gen5 MOS lineup.",                           sourceUrl:'https://us.glock.com/en/pistols/g47-mos.html' },
  { _id:'s2',  brand:'SIG Sauer',          model:'P365-XMACRO Comp',   category:'Pistol',  caliber:'9mm',       action:'Striker-Fired', msrp:699,  isJustDropped:true,  imageUrl:'/img/pistol.svg',         summary:'Compensated micro-compact with 17+1 capacity. Integrated compensator cuts muzzle flip dramatically.',              sourceUrl:'https://www.sigsauer.com/p365-xmacro-comp.html' },
  { _id:'s3',  brand:'Smith & Wesson',     model:'M&P15 Sport III',    category:'Rifle',   caliber:'5.56 NATO', action:'Semi-Auto',     msrp:749,  isJustDropped:true,  imageUrl:'/img/rifle.svg',                    summary:"Updated MSR with M-LOK handguard, dust cover, and forward assist standard. Best-value AR-15.",                    sourceUrl:'https://www.smith-wesson.com/firearms/rifles/mp-15' },
  { _id:'s4',  brand:'Ruger',              model:'LC Carbine',         category:'Rifle',   caliber:'5.7x28mm',  action:'Semi-Auto',     msrp:829,  isJustDropped:false, imageUrl:'/img/rifle.svg',                    summary:'Pistol-caliber carbine in 5.7x28mm. Takes FN FiveseveN magazines, threaded barrel standard.',                     sourceUrl:'https://www.ruger.com/products/lcCarbine/models.html' },
  { _id:'s5',  brand:'Mossberg',           model:'590S Shockwave',     category:'Shotgun', caliber:'12 Gauge',  action:'Pump',          msrp:549,  isJustDropped:false, imageUrl:'/img/shotgun.svg', summary:'Multi-caliber pump accepting 1.75in, 2.75in, and 3in shells. Raptor grip, non-NFA.',                               sourceUrl:'https://www.mossberg.com/product/590s-shockwave' },
  { _id:'s6',  brand:'Taurus',             model:'GX4 XL',             category:'Pistol',  caliber:'9mm',       action:'Striker-Fired', msrp:399,  isJustDropped:false, imageUrl:'/img/pistol.svg',           summary:'Extended micro-compact with improved ergonomics, 13+1 capacity. Best budget EDC in 2025.',                         sourceUrl:'https://www.taurususa.com/pistols/gx4-xl' },
  { _id:'s7',  brand:'Beretta',            model:'APX A1 Carry',       category:'Pistol',  caliber:'9mm',       action:'Striker-Fired', msrp:449,  isJustDropped:false, imageUrl:'/img/pistol.svg',            summary:'Slim EDC with removable chassis system. Optics-ready, flush 8+1 or extended 15-round magazines.',                  sourceUrl:'https://www.beretta.com/en-us/apx-a1-carry/' },
  { _id:'s8',  brand:'Daniel Defense',     model:'DDM4 V7 Pro',        category:'Rifle',   caliber:'5.56 NATO', action:'Semi-Auto',     msrp:2299, isJustDropped:false, imageUrl:'/img/rifle.svg',                    summary:'Pro-series with Geissele SSA trigger, Surefire SOCOM muzzle device, Milspec+ specs throughout.',                  sourceUrl:'https://danieldefense.com/ddm4-v7-pro.html' },
  { _id:'s9',  brand:'Springfield Armory', model:'Echelon',            category:'Pistol',  caliber:'9mm',       action:'Striker-Fired', msrp:599,  isJustDropped:false, imageUrl:'/img/pistol.svg',           summary:'Full-size duty pistol with Variable Interface System for direct-mount optics. 20+1 capacity.',                     sourceUrl:'https://www.springfield-armory.com/echelon-series/' },
  { _id:'s10', brand:'CZ',                 model:'P-10 F Competition', category:'Pistol',  caliber:'9mm',       action:'Striker-Fired', msrp:799,  isJustDropped:false, imageUrl:'/img/pistol.svg',         summary:'Competition-ready P-10F with extended mag well, flat trigger, ported barrel, 19+1 capacity.',                     sourceUrl:'https://cz-usa.com/product/cz-p-10-f-competition-ready/' },
  { _id:'s11', brand:'FN America',         model:'FN 15 DMR3',         category:'Rifle',   caliber:'5.56 NATO', action:'Semi-Auto',     msrp:1899, isJustDropped:true,  imageUrl:'/img/rifle.svg',                    summary:'Designated marksman rifle with Vortex Viper PST II optic, match-grade cold hammer forged barrel.',                 sourceUrl:'https://www.fnamerica.com/products/rifles/fn-15-dmr3/' },
  { _id:'s12', brand:'Kimber',             model:'Rapide Black Ice',   category:'Pistol',  caliber:'9mm',       action:'Single Action', msrp:1599, isJustDropped:false, imageUrl:'/img/pistol.svg',                              summary:'1911-platform with KimPro II finish, ball-milled slide, optics-ready cut, match-grade trigger.',                   sourceUrl:'https://www.kimberamerica.com/rapide-black-ice' },
]
