...
export async function POST(req) {
  ...
  if (action === 'seed') {
    ...
    const SEED = [
      ...
      // NRL22 National + Major Events
      { name:'NRL22 National Championship 2026', org:'NRL', discipline:'Precision Rifle', matchType:'National', level:'All Levels', startDate:'2026-08-07', endDate:'2026-08-09', city:'Burkesville', state:'KY', entryFee:200, registrationUrl:'https://nationalrifleleague.org', websiteUrl:'https://nationalrifleleague.org/nrl22', description:'NRL22 National Championship. .22 LR only. Rockcastle Shooting Center. Premier rimfire precision event.', featured:true },
      { name:'NRL22 Top Gun Invitational', org:'NRL', discipline:'Precision Rifle', matchType:'National', level:'Advanced', startDate:'2026-10-09', endDate:'2026-10-11', city:'Talladega', state:'AL', entryFee:350, registrationUrl:'https://nationalrifleleague.org', websiteUrl:'https://nationalrifleleague.org', description:'Top Gun Invitational — invitation-only championship for top-ranked NRL22 shooters from the season.' },
      { name:'NRL Hunter National Championship', org:'NRL', discipline:'Precision Rifle', matchType:'National', level:'All Levels', startDate:'2026-09-18', endDate:'2026-09-20', city:'Talladega', state:'AL', entryFee:250, registrationUrl:'https://nationalrifleleague.org', websiteUrl:'https://nationalrifleleague.org/nrl-hunter', description:'NRL Hunter National. Centerfire bolt gun. Hunting rifle class — no bipod, no rear bag for non-Open division.' },
      { name:'NRL22 Season Opener — Spring', org:'NRL', discipline:'Precision Rifle', matchType:'Regional', level:'Beginner Friendly', startDate:'2026-06-13', endDate:'2026-06-14', city:'Multiple Locations', state:'TX', entryFee:75, registrationUrl:'https://practiscore.com', websiteUrl:'https://nationalrifleleague.org/find-a-match', description:'NRL22 season opener club matches nationwide. Find your local match at nationalrifleleague.org/find-a-match. .22 LR, beginner welcome.' },
