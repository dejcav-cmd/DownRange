...
const CCW_STATE_DATA = {
  ...
  OR:{ permitType:'Shall-Issue', cc:false, minAge:21, fee:'$65', validity:4, redFlag:true, magLimit:false, awb:false,
    reciprocityCount:0, notes:'Oregon does not honor any out-of-state permits. Measure 114 magazine restrictions were permanently enjoined by federal court (Dec 2025) and are not enforced. Background check requirements remain active.' },
  ...
  RI:{ permitType:'May-Issue', cc:false, minAge:21, fee:'$40', validity:4, redFlag:false, magLimit:10, awb:false,
    reciprocityCount:0, notes:'Rhode Island does not honor out-of-state permits. Attorney General issues permits on case-by-case basis. Magazine limit: 10 rounds (all firearms). Owners had until Jan 1, 2023 to modify/surrender/transfer. Violation: up to 5 years prison, $5,000 fine. Upheld by federal appeals court (2024).' },
  ...
  VT:{ permitType:'Constitutional (no permit issued)', cc:true, minAge:16, fee:'N/A', validity:'N/A', redFlag:false, magLimit:10, awb:false,
