...
const ALL_JOBS = [
  ...
  { id:'giveaways',        path:'/api/cron/giveaways',             schedule:'0 8,14,20 * * *',   label:'Giveaways Feed (3×/day)', group:'Content', icon:'🎁', critical:false, desc:'Scrapes wintheguns.com, gungiveaways.net, and manufacturer promo pages 3× daily. Replaced AI hallucinator with real web scraper.' },
