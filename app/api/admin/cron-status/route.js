...
export const ALL_JOBS = [
  ...
  { id:'laws',             path:'/api/agent?feed=laws',             schedule:'0 */6 * * *',   label:'Laws Feed',               group:'Content',  icon:'⚖',  critical:false, desc:'Congress.gov + LegiScan → legislation every 6 hrs' },
  ...
  { id:'goa',              path:'/api/agent?feed=goa',              schedule:'2 */6 * * *',   label:'GOA Feed',                group:'Content',  icon:'🦅', critical:false, desc:'Gun Owners of America press feed every 6 hrs' },
  { id:'quality-rewrite',  path:'/api/cron/quality-rewrite',        schedule:'10 */12 * * *', label:'Quality Rewrite',         group:'Content',  icon:'✨', critical:false, desc:'Scans content for AI phrases + short bodies → rewrites failing items. Every 12 hours.' },
