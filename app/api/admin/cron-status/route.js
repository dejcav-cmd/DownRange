...
export const ALL_JOBS = [
  ...
  { id:'amazon-brands',   path:'/api/cron/amazon-brands',          schedule:'0 4,16 * * *',    label:'Amazon Brand Scraper',     group:'Content', icon:'🎯', critical:false, desc:'Scrapes Olight, Monstrum Tactical, Vortex Optics brand pages via Jina — 2A-filtered' },
