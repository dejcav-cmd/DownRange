...
export const ALL_JOBS = [
  ...
  { id:'nfa-wait-times',   path:'/api/nfa-wait-times',              schedule:'0 6 */2 * *',   label:'NFA Wait Times',          group:'System',   icon:'⏳', critical:false, desc:'Scrapes ATF + SilencerShop for NFA processing times every 2 days, 6am UTC' },
