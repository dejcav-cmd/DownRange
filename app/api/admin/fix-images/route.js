...
export async function POST(req) {
  ...
  const QUERIES = [
    `*[_type=="newsArticle"    && (${force ? 'true && editorLocked != true' : '!defined(imageUrl) || imageUrl == "" || string::startsWith(imageUrl, "/img/pistol") || string::startsWith(imageUrl, "/img/rifle") || string::startsWith(imageUrl, "/img/shotgun") || string::startsWith(imageUrl, "/img/suppressor") || string::startsWith(imageUrl, "/img/ammo") || string::startsWith(imageUrl, "/img/law") || string::startsWith(imageUrl, "/img/news")'})] | order(publishedAt desc) [0...${batch}] { _id, title, imageUrl, sourceUrl, category }`,
    `*[_type=="blogPost"       && (${force ? 'true && editorLocked != true' : '!defined(imageUrl) || imageUrl == "" || string::startsWith(imageUrl, "/img/pistol") || string::startsWith(imageUrl, "/img/rifle") || string::startsWith(imageUrl, "/img/shotgun") || string::startsWith(imageUrl, "/img/suppressor") || string::startsWith(imageUrl, "/img/ammo") || string::startsWith(imageUrl, "/img/law") || string::startsWith(imageUrl, "/img/news")'})] | order(_createdAt desc) [0...20] { _id, title, imageUrl, category }`,
    `*[_type=="firearmRelease" && (${force ? 'true && editorLocked != true' : '!defined(imageUrl) || imageUrl == "" || string::startsWith(imageUrl, "/img/pistol") || string::startsWith(imageUrl, "/img/rifle") || string::startsWith(imageUrl, "/img/shotgun") || string::startsWith(imageUrl, "/img/suppressor") || string::startsWith(imageUrl, "/img/ammo") || string::startsWith(imageUrl, "/img/law") || string::startsWith(imageUrl, "/img/news")'})] | order(_createdAt desc) [0...30] { _id, "title": brand+" "+model, imageUrl, sourceUrl, category }`,
    `*[_type=="review"         && (${force ? 'true && editorLocked != true' : '!defined(imageUrl) || imageUrl == "" || string::startsWith(imageUrl, "/img/pistol") || string::startsWith(imageUrl, "/img/rifle") || string::startsWith(imageUrl, "/img/shotgun") || string::startsWith(imageUrl, "/img/suppressor") || string::startsWith(imageUrl, "/img/ammo") || string::startsWith(imageUrl, "/img/law") || string::startsWith(imageUrl, "/img/news")'})] | order(_createdAt desc) [0...20] { _id, "title": brand+" "+model, imageUrl, category }`,
    `*[_type=="canadaContent"  && (${force ? 'true && editorLocked != true' : '!defined(imageUrl) || imageUrl == "" || string::startsWith(imageUrl, "/img/pistol") || string::startsWith(imageUrl, "/img/rifle") || string::startsWith(imageUrl, "/img/shotgun") || string::startsWith(imageUrl, "/img/suppressor") || string::startsWith(imageUrl, "/img/ammo") || string::startsWith(imageUrl, "/img/law") || string::startsWith(imageUrl, "/img/news")'})] | order(_createdAt desc) [0...20] { _id, title, imageUrl, category }`,
  ]
