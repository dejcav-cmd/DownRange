...
export async function POST(req) {
  ...
  try {
    ...
    const result = await resend.emails.send({
      ...
      subject,
      text: body,
      html: `<div style="font-family:monospace;max-width:600px;margin:0 auto;background:#0A0B0C;color:#F0EDE6;padding:32px"><h1 style="color:#C8922A;font-family:Georgia,serif;letter-spacing:2px">${subject}</h1><div style="line-height:1.8;color:#94A3B8">${body.replace(/\n/g,'<br>')}</div><hr style="border-color:#1F2428;margin-top:32px"><p style="font-size:11px;color:#4B5563">DownRange · America's Firearms Intelligence Hub · <a href="https://downrangeco.com/unsubscribe" style="color:#C8922A">Unsubscribe</a></p></div>`,
    })
