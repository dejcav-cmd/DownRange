...
const FOOTER_COLS = [
  ...
  { title: 'Tools', links: [['NFA Tracker','/nfa-tracker'],['CCW Insurance','/carry-insurance'],['FFL Finder','/ffl-finder'],['Gun Compare','/compare/glock-19-vs-sig-p320'],['Range Finder','/ranges']] },
