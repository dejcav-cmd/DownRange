...
// Official brand icons from the Simple Icons project (simpleicons.org,
// CC0), not hand-drawn approximations. All rendered with fill="currentColor"
// so the existing per-platform tint/border styling below still drives color.
const ICONS = {
  bluesky: (
