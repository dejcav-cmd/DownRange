 ...
 * Appears fixed at bottom-right on all Arsenal Americano pages.
 */
  ...
  return (
    <>
      <style>{`
        ...
        .aa-wa-float svg { flex-shrink: 0; }
        @media (max-width: 600px) {
          .aa-wa-float { padding: 12px; border-radius: 50%; }
          .aa-wa-float span { display: none; }
        }
      `}</style>
      <a
