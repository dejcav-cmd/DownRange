...
const SETUP = {
  ...
  twitter:  { steps:['Sign up at zernio.com (account, no card yet)','Connect X/Twitter account via OAuth','Billing tab → add card + set monthly cap ($25 suggested)','Dashboard → API Keys → copy key','Connected Accounts → copy your X account ID','Add ZERNIO_API_KEY + ZERNIO_TWITTER_ACCOUNT_ID to Vercel → redeploy','Note: $0.20/URL post. ~$18/mo at 3 posts/day.'], url:'https://zernio.com' },
