...
const TEMPLATES = [
  { id:'intro-youtuber', name:'YouTuber — Intro', cat:'youtuber', subject:`{{firstName}} — wanted you to hear about this directly`, greeting:'Hey {{firstName}},', preheader:'Built something for the 2A community. Your content is already part of it.', body:`My name is DJ Cavalcanti. I'm a gun owner based in Washington state, and a couple of years ago I got frustrated — frustrated that the firearms community had no real home on the internet. Not a forum. Not a YouTube channel. An actual intelligence platform. So I built one.\n\nDownRange (downrangeco.com) covers breaking 2A news from 13+ sources updated every 15 minutes, gun laws for all 50 states with CCW reciprocity, new manufacturer releases tracked across 16+ brands, live ammo prices, NFA wait times, and NICS data. No ads. No manufacturer funding. No pay-to-play. Free for the community — always.\n\nHere's why I'm reaching out personally.\n\n{{channelName}} is already featured on DownRange. Gun owners using the platform can find your videos in our Video Hub — outside the algorithm, in front of people who are actively there for firearms content. I added it because it belongs there. But I wanted you to know about it, not find out by accident.\n\nIf you'd prefer not to have your content featured on the platform, just say the word — I'll remove it immediately, no questions asked. Your call entirely.\n\nBut I'm also hoping this becomes the start of something more useful than that. The firearms community is at its best when creators and platforms work together instead of in separate silos. Here's what I think could be genuinely valuable for both sides:\n\n— A mention in a video description — something like "All 50-state gun laws and live ammo prices at DownRange: downrangeco.com" — sends your audience to a free resource they'll actually use\n— A share or shoutout for any DownRange content that lines up with what you cover — we publish original 2A news and analysis daily\n— A dedicated creator profile on DownRange linking back to your channel — putting your work in front of a firearms-engaged audience that doesn't all live on YouTube\n\nThis isn't a sponsorship. I'm not asking you to read an ad or pretend to use something. I'm asking because the people watching {{channelName}} are exactly the people DownRange was built for — and I think they deserve to know both exist.\n\nIf this sounds worth a conversation, reply here. If you want the channel removed instead — also reply here. Either way, I'd rather hear from you directly.`, ctaText:'See Your Channel on DownRange', ctaUrl:'https://downrangeco.com/video' },
