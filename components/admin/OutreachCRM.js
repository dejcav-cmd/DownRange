...
function buildEmailHTML({ subject, preheader, greeting, body, ctaText, ctaUrl, contactName, senderName='DJ Cavalcanti', signature='', accentColor=GOLD }) {
  ...
  const cta = ctaText && ctaUrl ? `<div style="margin:28px 0 8px;"><a href="${ctaUrl}" style="display:block;background:${accentColor};color:#000;padding:14px 36px;text-decoration:none;font-weight:700;font-size:14px;letter-spacing:0.03em;text-align:center;">${ctaText} &rarr;</a></div>` : ''
  const sig = signature
  ...
  const preheaderHtml = preheader
    ...
    : ''
  const bodyParasHtml = b.split('\n\n').filter(Boolean)
    .map(function(p) { return '<p style="margin:0 0 16px;font-size:15px;color:#d1d5db;line-height:1.9;">' + p.replace(/\n/g, '<br>') + '</p>' })
    .join('')
  return `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${subject||'DownRange'}</title></head><body style="margin:0;padding:0;background:#09090B;font-family:Arial,Helvetica,sans-serif;">${preheaderHtml}<table width="100%" cellpadding="0" cellspacing="0" style="background:#09090B;padding:32px 16px;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background:#0A0B0C;border:1px solid #1f2428;max-width:600px;width:100%;"><tr><td style="background:#0d0e10;border-bottom:3px solid ${accentColor};padding:20px 36px;"><img src="https://downrangeco.com/img/logo-banner.png" alt="DownRange" width="480" height="auto" style="display:block;height:auto;max-height:58px;width:auto;max-width:100%;"></td></tr><tr><td style="padding:32px 36px 24px;"><p style="font-size:15px;color:#9ca3af;line-height:1.8;margin:0 0 18px;">${g}</p><div style="font-size:15px;color:#d1d5db;line-height:1.9;font-size:15px;color:#d1d5db;line-height:1.9;">${bodyParasHtml}</div>${cta}<div style="margin-top:32px;padding-top:20px;border-top:1px solid #1f2428;">${sig}</div></td></tr><tr><td style="padding:0 36px;"><div style="height:1px;background:linear-gradient(90deg,${accentColor}22,${accentColor},${accentColor}22);"></div></td></tr><tr><td style="padding:16px 36px 24px;background:#050506;"><table width="100%" cellpadding="0" cellspacing="0"><tr><td style="font-size:10px;color:#374151;line-height:1.7;">DownRange Media LLC &middot; America's Firearms Intelligence Hub<br><a href="https://downrangeco.com/press" style="color:${accentColor};text-decoration:none;">Press Kit</a> &nbsp;&middot;&nbsp; <a href="https://downrangeco.com" style="color:#4b5563;text-decoration:none;">downrangeco.com</a></td><td align="right" style="vertical-align:bottom;"><a href="{{unsubscribeUrl}}" style="color:#374151;text-decoration:none;font-size:9px;letter-spacing:.08em;">Unsubscribe</a></td></tr></table></td></tr></table></td></tr></table></body></html>`
}

const TEMPLATES = [
  { id:'intro-youtuber', name:'YouTuber — Introduction & Embed Permission (Primary)', cat:'youtuber', subject:`DJ from DownRange — wanted to tell you directly`, greeting:'Hello {{firstName}},', preheader:'', body:`My name is DJ Cavalcanti, and I'm a Washington State resident and the founder of DownRange Co. ( https://www.downrangeco.com/ )\n\nA few years ago, I became frustrated by how fragmented the firearms community was online. We had forums, YouTube channels, social media groups, and news sites, but no central place where gun owners could quickly find reliable information and quality content. So I decided to build one.\n\nDownRange is a recently launched and free platform built specifically for the firearms community. It brings together breaking Second Amendment news, firearm laws for all 50 states with CCW reciprocity information, new firearm releases from multiple manufacturers, live ammunition pricing, NFA wait times, NICS data, and curated content from trusted creators across the industry.\n\nI'm reaching out because I'd love to feature {{channelName}} on DownRange.\n\nOur mission is simple: help firearm enthusiasts discover reliable information, useful resources, and quality creators in one place. Your channel aligns with that mission, and I believe our users would find your content valuable. Featuring your channel would allow visitors to discover your videos through our platform while providing direct links back to your channel and helping grow your audience within the firearms community.\n\nThat said, I hope this can be the beginning of a mutually beneficial relationship. The firearms community grows stronger when creators, publishers, and platforms work together to support responsible firearm ownership and Second Amendment advocacy.\n\nIf you're interested, we'd love to feature your channel on DownRange through a dedicated creator profile and inclusion in our Video Hub, helping firearm enthusiasts discover your content alongside the news, resources, and tools they already use on the platform.\n\nA few opportunities that could benefit both sides include:\n\n* A dedicated creator profile on DownRange that links directly back to your channel and helps firearm-focused users discover your content.\n* Featuring your videos within our Video Hub, putting your content in front of an audience actively seeking firearms-related information, reviews, training, and industry updates.\n* Mentioning DownRange as a free resource for 50-state gun laws, CCW reciprocity information, live ammunition pricing, NFA wait times, and firearms news.\n* Sharing or referencing DownRange content when it aligns with topics you cover. We publish original Second Amendment news, industry updates, and analysis daily.\n\nThis is not a sponsorship request, and I'm not asking you to promote something you don't believe in. My goal is simply to connect the firearms community with useful resources and quality creators. The audience that follows your channel is exactly who DownRange was built to serve.\n\nIf you'd like to discuss opportunities to work together, I'd love to hear from you. If you'd prefer not to have your content featured on DownRange, just let me know and I'll respect that decision completely. I also appreciate any feedback you can share to improve the portal and the experience of our viewers.\n\nThank you for your time, and I appreciate everything you do for the firearms community.\n\nBest regards,\nDJ Cavalcanti\nFounder, DownRange Co.\nhttps://www.downrangeco.com/`, ctaText:'', ctaUrl:'' },
  { id:'intro-manufacturer', name:'Manufacturer — Partnership & Press Coverage', cat:'manufacturer', subject:'DownRange — covering your releases for the 2A community', greeting:'Hi {{firstName}},', preheader:'The firearms industry deserves media that treats manufacturers like partners.', body:`My name is DJ Cavalcanti, founder of DownRange (downrangeco.com). I built this platform because the firearms industry deserves media coverage that treats manufacturers like partners — and because gun owners deserve accurate, timely information about the products they carry.\n\nDownRange is an independent firearms intelligence portal. We cover breaking legislation, new product releases, market data, and 2A news daily. Our audience are active buyers, FFLs, competitive shooters, and daily carriers who make purchasing decisions based on what they read.\n\nI'd like to cover your releases as they happen. We publish what's true and what matters to people who take the Second Amendment seriously.\n\nIf you have a media contact, press releases, or a PR list, I'd genuinely appreciate being added.`, ctaText:'Visit Our Press Page', ctaUrl:'https://downrangeco.com/press' },
  { id:'intro-ffl', name:'Gun Shop & FFL — Introduction', cat:'ffl_dealer', subject:'DJ from DownRange — wanted to reach out directly', greeting:'Hello {{firstName}},', preheader:'', body:`My name is DJ Cavalcanti. I'm a Washington State resident and the founder of DownRange Co. ( https://www.downrangeco.com/ )\n\nDownRange is a free platform built specifically for the firearms community. It brings together breaking Second Amendment news, firearm laws for all 50 states with CCW reciprocity information, new firearm releases from multiple manufacturers, live ammunition pricing, NFA wait times, NICS data, and curated content from across the industry.\n\nI built it because gun owners deserve a single, reliable place to find this information — and because the industry deserves better than scattered forums and paywalled news sites.\n\nI'm reaching out because FFLs are the backbone of the firearms community. The work your shop does every day — processing transfers, helping first-time buyers make informed decisions, navigating NFA paperwork, keeping customers compliant with state and federal law — is exactly what DownRange was built to support.\n\nWe'd love to add {{businessName}} to our dealer directory, completely free. When someone in your area searches for a licensed dealer, a transfer FFL, or an NFA specialist, we want them finding you.\n\nBeyond the listing, I have a bigger ask.\n\nIf you find DownRange useful — and I think you will — I'd genuinely appreciate you sharing it with your team and your customers. Show it to the counter staff. Mention it when a customer asks about state laws or CCW reciprocity. Put it in your next email or post. The people walking through your door are exactly who we built this for, and a recommendation from a trusted dealer carries more weight than anything we could do on our own.\n\nOne more thing: if anyone on your team has something worth saying — an insight on NFA trends, a breakdown of a new state law, an opinion on the market — DownRange accepts contributor articles. We publish original content from people inside the industry who know what they're talking about. No editorial spin, no agenda. Just useful information for gun owners.\n\nIf you'd like to be listed, want to discuss contributing, or just have feedback on the portal, reply here and I'll take care of it personally.\n\nThank you for what you do for the community.\n\nBest regards,\nDJ Cavalcanti\nFounder, DownRange Co.\nhttps://www.downrangeco.com/`, ctaText:'Visit DownRange', ctaUrl:'https://downrangeco.com' },
  { id:'intro-holster', name:'Holster Company — Introduction & Coverage', cat:'holster', subject:'DownRange — featuring your brand for daily carriers', greeting:'Hi {{firstName}},', preheader:'Our audience carries every day. They want honest gear recommendations.', body:`My name is DJ Cavalcanti, founder of DownRange (downrangeco.com). I built this platform for gun owners who carry every day — people who take their equipment seriously.\n\nA good holster is something someone trusts their life to. That's why we dedicated an entire section to holster coverage — and why I'm reaching out specifically.\n\nI'd like to feature your brand. We don't do pay-to-play — if your holsters earn a spot, it's because our readers would genuinely benefit from knowing about them.\n\nIf you'd like to be featured, I'd love to learn more about what you're building.`, ctaText:'See Our Holster Coverage', ctaUrl:'https://downrangeco.com/holsters' },
  ...
  { id:'followup', name:'All — Follow-Up (14 Days)', cat:null, subject:'Following up — DownRange', greeting:'Hey {{firstName}},', preheader:'Keeping this short.', body:`I wanted to follow up on my previous note about DownRange (downrangeco.com).\n\nI'll keep this brief. DownRange is the independent firearms intelligence portal I'm building for gun owners who want serious, accurate information.\n\nIf now isn't the right time, no hard feelings. Either way, keep doing what you're doing.`, ctaText:"See What We're Building", ctaUrl:'https://downrangeco.com' },
  { id:'intro-organization', name:'Organization — Introduction & Community Resource', cat:'organization', subject:'DJ from DownRange — a resource for your members', greeting:'Hello {{firstName}},', preheader:'', body:`My name is DJ Cavalcanti. I'm a Washington State resident and the founder of DownRange Co. ( https://www.downrangeco.com/ )\n\nDownRange is a free platform built specifically for the firearms community. It brings together breaking Second Amendment news, firearm laws for all 50 states with CCW reciprocity information, live ammunition pricing, NFA wait times, NICS data, and curated content from trusted voices across the industry — all in one place, free of charge.\n\nI'm reaching out because the work {{businessName}} does matters. Whether you're fighting for Second Amendment rights in court, training the next generation of responsible gun owners, or keeping your members informed on legislation that affects them directly — DownRange was built to support exactly that mission.\n\nA few ways we could work together:\n\nList {{businessName}} on DownRange as a trusted 2A organization, giving your mission visibility in front of an audience that cares deeply about the Second Amendment.\n\nShare DownRange with your members as a free resource for 50-state gun laws, CCW reciprocity, live ammo pricing, NFA wait times, and daily firearms news. It costs nothing and gives them a reliable place to find information they already need.\n\nIf your organization publishes analysis, legislative updates, or advocacy content, we'd welcome contributions directly on DownRange. We publish original articles from people who know this space — no editorial agenda, no spin.\n\nCross-reference or link to DownRange content when it aligns with what you're communicating to members. We cover Second Amendment legislation, court decisions, and industry developments daily.\n\nThis is not a sponsorship request. I'm not asking for money, endorsements, or anything that puts your credibility at risk. My goal is to make DownRange a resource your members actually use — and to support the organizations doing the hard work of protecting the rights we all depend on.\n\nIf there's an opportunity to work together, I'd genuinely welcome the conversation. And if you have feedback on the portal, I'd appreciate hearing it.\n\nThank you for everything your organization does for the community.\n\nBest regards,\nDJ Cavalcanti\nFounder, DownRange Co.\nhttps://www.downrangeco.com/`, ctaText:'Visit DownRange', ctaUrl:'https://downrangeco.com' },
...
export default function OutreachCRM({ adminKey }) {
  ...
  async function sendToSel() {
    ...
    for(const c of targets){
      ...
      const html=buildEmailHTML({subject,preheader,greeting,body:personalizedBody,ctaText,ctaUrl,contactName:firstName,accentColor:accent,signature:sig}).replace('{{unsubscribeUrl}}','https://downrangeco.com/api/outreach/unsubscribe?email='+encodeURIComponent(c.email))
      const subj=subject
        .replace(/\{\{firstName\}\}/g,firstName)
        .replace(/\{\{businessName\}\}/g,c.name||'')
        .replace(/\{\{channelName\}\}/g,c.name||'')
  ...
  async function queueDrafts(){
    ...
    for(const c of targets){
      ...
      const subj=subject
        .replace(/\{\{firstName\}\}/g,firstName)
        .replace(/\{\{businessName\}\}/g,c.name||'')
        .replace(/\{\{channelName\}\}/g,c.name||'').replace(/\{\{channelName\}\}/g,c.name||'')
      try{
  ...
  async function saveToZohoDrafts(){
    if(!selIds.size){flash('Select contacts first',false);return}
    setSending(true)
    const bodyTpl=getBody()||(tplTemplates.find(t=>t.id===activeTpl)?.body||'')
    const targets=contacts.filter(c=>selIds.has(c._id))
    const noEmail=targets.filter(c=>!c.email)
    ...
    for(const c of targets.filter(c=>c.email)){
      ...
      const subj=subject
        ...
        .replace(/\{\{businessName\}\}/g,c.name||'')
        .replace(/\{\{channelName\}\}/g,c.name||'')
      const html=buildEmailHTML({subject:subj,preheader,greeting,body:personalizedBody,ctaText,ctaUrl,contactName:firstName,accentColor:accent,signature:sig})
      drafts.push({to:c.email,toName:c.name||'',subject:subj,htmlBody:html})
    }
    let created=0,failed=0,lastErr=''
    try{
      const r=await fetch('/api/admin/zoho-draft',{method:'POST',headers:H,body:JSON.stringify({drafts})})
      const d=await r.json()
      created=d.created||0
      failed=d.failed||0
      if(d.results) lastErr=(d.results.find(x=>!x.ok)?.error||'').slice(0,80)
    }catch(e){failed=drafts.length;lastErr=e.message}
    setSending(false)
    setSelIds(new Set())
    if(failed>0) flash('❌ '+failed+' failed'+(lastErr?' — '+lastErr:'')+(created?' · 📝 '+created+' saved to Zoho':''),false)
