...
export const PULL_SOURCES = {
  ...
  PRN_SCRAPER:     { id:'prn_scraper',      label:'PRN Releases Scraper',  type:'api', category:'releases' },
  MFR_RELEASES:    { id:'mfr_releases',     label:'Manufacturer Releases', type:'rss', category:'releases' },
}
