...
const DEFAULT_CHAINS = {
  // High-volume, runs 96×/day — cheapest possible, quality just needs to be "good enough"
  news:     'glm:glm-4.5-air,anthropic:claude-haiku-4-5-20251001',
  // Backfill runs hourly — cheap tier  
  backfill: 'glm:glm-4.5-air,anthropic:claude-haiku-4-5-20251001',
  ...
  article:  'glm:glm-4.7,anthropic:claude-sonnet-4-5',
  // Outreach — mid tier, professional tone
  outreach: 'glm:glm-4.7,anthropic:claude-sonnet-4-5',
  // Intelligence briefing — best quality, runs once/day, worth the cost
  intel:    'anthropic:claude-sonnet-4-5,glm:glm-4.7',
  // Newsletter — best quality, goes to subscribers
  newsletter: 'anthropic:claude-sonnet-4-5,glm:glm-4.7',
  // Fast/bulk operations — cheapest
  fast:     'glm:glm-4.5-air,anthropic:claude-haiku-4-5-20251001',
  // Default fallback for anything unspecified
  default:  'glm:glm-4.7,anthropic:claude-sonnet-4-5',
}
...
export async function callAI({ prompt, maxTokens = 1200, systemPrompt = null, useCase = 'default', chain = null }) {
