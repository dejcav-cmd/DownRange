...
// Convenience: pick tier automatically based on use case label
export function aiForUseCase(useCase) {
  const tierMap = {
    news:        'nano',   // high volume, quality nice-to-have
    backfill:    'nano',   // high volume, acceptable quality
    laws:        'cheap',  // medium volume, summary only
    market:      'nano',   // pure data extraction
    releases:    'mid',    // product articles, readable quality
    outreach:    'mid',    // emails, personalized
    canada:      'mid',    // editorial, readable
    newsletter:  'mid',    // weekly digest
    blog:        'smart',  // public-facing, high quality
    intelligence:'smart',  // daily briefing, high quality
    default:     'cheap',
  }
